...
toc-expand: true
# Content overwritten from an earlier version - 2025-06-03 17:19
---
...
#### What
This is the backend half of this ticket to improve onboarding new organizations that encounter errors.

This PR also includes the ability to attach Cursor to the local running API container and set debug breakpoints.

This PR also includes the ability for the container to reload the API code while editing it without restarting the container.
