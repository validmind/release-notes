---
title: "Add date localization support across the application (#1312)"
categories: [frontend, 25.05, release, enhancement]
sidebar: release-notes
toc-expand: true
date: "April 28, 2025"
# CHECK: Title validation failed - The edited content effectively condenses the original content while maintaining its core message. The original reference "[SC-9370]" seems to be an internal identifier, which is omitted in the edited version, focusing solely on the action required. This makes the edited content more direct and actionable, which is suitable for a task or feature description. However, if the identifier is important for tracking or context, it should be retained. Overall, the edit is clear and concise.
