...
This release includes the ability to customize finding statuses via the API, the inclusion of custom fields in exported organization templates, and the option to upload sourcemaps to Datadog and Sentry without deployment.
...
<!--- Labels: enhancement --->
### Enable customization of finding statuses via the `API` (#1499)
